...
<head>
  ...
  <link rel="stylesheet" href="../plugins/select2/select2.min.css">
	...
	<body>	
    <div class="content">
    	<h3 class="text-center">编辑用户信息</h3>
    	<c:url var="addAction" value="super/update/user/info/${user.id}" ></c:url>
   	  	<form:form action="${addAction}" commandName="admin">
			   		<%@ include file="edit_userinfo_form.jsp"%>	  
			    <div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<input class="btn btn-success pull-right" type="submit" value="<spring:message text="更新"/>" />
					</div>
				</div> 
	...
	<script src="../plugins/bootstrap-formhelper-2.3.0/js/bootstrap-formhelpers.js"></script>
	<!-- Select2 -->
