...
<div class="wrapper">
  ...
  <!-- 图片上传 -->
	<link href="resources/plugins/edit-image-upload/css/cropper.min.css" rel="stylesheet">
	<link href="resources/plugins/edit-image-upload/css/sitelogo.css" rel="stylesheet">
	<script src="resources/plugins/edit-image-upload/js/cropper.min.js"></script>
	<script src="resources/plugins/edit-image-upload/js/sitelogo.js"></script>	
 ...
 <section class="content-header">
	      ...
	      <div class="col-md-12">
	          <div class="box box-info frame-mini">
	            <div class="box-header with-border">
	              <h3 class="box-title">超级管理员个人中心</h3>
	            </div>
	            <div class="box-body" >
	      						...
	      						<div class="callout callout-gray">
	      							<div class="row">
										...
										<div id="crop-avatar" hidden>
											<div class="avatar-view" title=""></div>
										</div>
										<div class="col-md-9">
											<p></p>		
											<li>
												<strong>用户组：</strong>超级管理员	
											...
											<li>
												<strong>角色：</strong>${user.role.name}	
												<div class="dotted-line"></div>				
											</li>
										</div>	
									</div>		
									...
									<li>
										<strong> </strong>
										<button class="btn btn-xs btn-social btn-success" onclick="edit_image()">
										...
										<button class="btn btn-xs btn-social btn-success" onclick="layer_test()">
											<i class="fa fa-edit"></i>测试弹出
										</button>
  ...
  <!-- 编辑头像 -->
	<jsp:include page="edit_userimage.jsp"/>
...
<script type="text/javascript">
	function layer_test()
	{
		$("#test01").trigger('click');
	}
</script>


<div aria-hidden="true">										
<button id="test00" class="btn btn-xs btn-social btn-success" href="remote.html" data-toggle="modal" data-target="#myModal"></button>	
<button id="test01" class="btn btn-xs btn-social btn-success" data-toggle="modal"  href="super/add/organization" data-target="#myModal"></button>	
<a data-toggle="modal" href="admin/add/announcement" data-target="#myModal">Click me</a>
</div>
