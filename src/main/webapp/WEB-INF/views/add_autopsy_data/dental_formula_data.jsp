      	...
      	<div class="picture-frame-gray">
						...
						<c:url var="addAction" value="/super/autopsy_data/add"></c:url>
      					...
      					<li class="line">
							...
							<form:input id="autopsy_classification" path="autopsy_classification" value="dental_formula_data" readonly="true" type="hidden"/>
							<strong>
								测定组数据：
							</strong>
								...
								<br/><div class="dotted-line"></div>
									...
									<div class="dotted-line-nocolor"></div>
										...
										<form:label path="permanent_tooth"><font class="second-embed">恒齿：</font></form:label><form:input path="permanent_tooth"/><div class="dotted-line-nocolor"></div>
										<br/><div class="dotted-line"></div>
								</div>
      							<form:input path="time" value="<%=str_date1%>" readonly="true" type="hidden"/>
									<div id="submit">
											<input type="submit" value="<spring:message text="添加齿式数据"/>" />
									</div>
									<p></p>
      						</li>  	
      						<!-- ====================================================以上为第二层信息【遗传数据】=============================================================== -->  
