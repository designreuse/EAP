...
<div class="form-group">
	<label class="col-sm-2 control-label">教育培训标题：</label>
		<div class="col-sm-10">
			<form:input class="form-control" placeholder="请输入教育培训标题" path="title" />
		</div>
	...
	<label class="col-sm-2 control-label">教育培训正文：</label>
		<div class="col-sm-10">
