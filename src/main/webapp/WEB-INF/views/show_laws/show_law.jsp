...
<div class="wrapper">
  ...
  <!-- Main Sidebar -->
	<jsp:include page="../shell_frame/shell_frame_sidebar-1-4.jsp"/>
	      ...
	      <div class="col-md-12">
	          <div class="box box-info frame-mini">
	            <div class="box-header with-border">
	              <h3 class="box-title">法律法规详情</h3>
	            </div>
	            <div class="box-body" >		            
	            <h3 class="text-center">${law.title}</h3>		
					...
					<div class="faceplate" >
						<div class="embed">										
      					...
      					<!-- ====================================================以上为第一层信息【基本信息】=============================================================== --> 
      							...
      							<div class="row col-md-12">
								<c:if test="${!empty law.time}">
									<p><div class="text-right" style=" text-align:right;">发布时间：${law.time}&nbsp;</div></p>
								</c:if>	
								</div>
					</div>
				</div>
