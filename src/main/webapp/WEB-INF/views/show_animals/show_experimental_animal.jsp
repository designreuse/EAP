	      ...
	      <div class="col-md-12">
	          <div class="box box-info frame-mini">
	            <div class="box-header with-border">
	              <h3 class="box-title">实验动物详情</h3>
	            </div>
	            <div class="box-body" >					    
    			<h3 class="text-center">${experimental_animal.name}         			 
        		<c:if test="${pageContext.request.userPrincipal.name != null}">
        		<% int collection_on=0;%>
        			<c:forEach items="${list_sydw}" var="sydw">
        				<c:if test="${sydw.collection_id eq experimental_animal.id}">        				
        					<c:if test="${sydw.user_id.id eq admin.id}">
        						<% collection_on=1;%>        						
						...
						<div class="embed">				
	      						...
	      						<div class="row">
									<c:if test="${!empty experimental_animal.photo_id.id}">											
				  						<div class="col-md-3">
											<figure><img src="${experimental_animal.photo_id.url}${experimental_animal.photo_id.name}" alt="" width="90%" height="90%"></figure>
										</div>
									</c:if>	
								<div class="col-md-9">
									<p></p>
									...
									<c:if test="${!empty experimental_animal.phenotype}">
										<li>
											<strong>表型描述：</strong>${experimental_animal.phenotype}								
										</li>
										<div class="dotted-line"></div>
									</c:if>			
...
<!-- ====================================================以上为第一层信息【基本信息】=============================================================== --> 
<!-- ====================================================以下为第二层信息【相关实验】=============================================================== -->    																
      				<div id="second_level_menu_title-01" class="second_leve_menu row col-md-12 hidden">
      						...
      						<img id="second_level_menu_image-01" src="resources/images/plus.png">
      							<span>相关实验</span>
      								...
      								<!-- ====================================================以下为第二层信息【可提供的相关供技术服务】=============================================================== -->    																
      									...
      									<div id="second_level_menu_title-02" class="second_leve_menu row col-md-12 hiden">
      										<a href="javascript:void(0);">
