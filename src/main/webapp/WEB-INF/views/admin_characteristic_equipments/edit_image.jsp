...
<body>
    ...
    <div class="content">  
    	<c:url var="addAction" value="admin/updata/characteristic_equipment" ></c:url>
		<form:form action="${addAction}" commandName="characteristic_equipment">
			   		<%@ include file="characteristic_equipment_form.jsp"%> 	  
