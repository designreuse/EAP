			        ...
			        <div class="col-md-12">
			          ...
			          <div class="nav-tabs-custom">
			            <ul class="nav nav-tabs">
			              <li class="active"><a href="#tab_1" data-toggle="tab">特色设备</a></li>
			              <li><a href="#tab_2" data-toggle="tab">常规设备</a></li>
			            </ul>
			            <div class="tab-content">
			              <div class="tab-pane active" id="tab_1">
			                <%@ include file="characteristic_equipment_list.jsp"%> 
			              </div>
			              <div class="tab-pane" id="tab_2">
			                <%@ include file="common_equipment_list.jsp"%> 
			              </div>
			            </div>
			          </div>
			        </div>
