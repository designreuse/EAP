	...
	<div id="content">
		...
		<div class="inner">
			<div class="container_12">
				...
				<div class="wrapper">
					<div class="grid_12">
						<h2 class="h-pad1">平台服务</h2>
						<ul class="wrapper works">
							<li class="grid_4 alpha">
								<figure><img src="resources/images/service01.jpg" alt=""></figure>
								<p><a href="#" class="link">动物定制</a></p>
								本平台各组织成员所提供的动物模型定制服务。
								<p><a href="#" class="button">查看详情</a></p>
							</li>
							<li class="grid_4">
								<figure><img src="resources/images/service02.jpg" alt=""></figure>
								<p><a href="#" class="link">检测服务</a></p>
								本平台各组织成员所做特有的实验设备。
								<p><a href="#" class="button">查看详情</a></p>
							</li>
							<li class="grid_4 omega">
								<figure><img src="resources/images/service03.jpg" alt=""></figure>
								<p><a href="#" class="link">委托实验</a></p>
								本平台各组织成员在研究中发现的科研成果。
								<p><a href="#" class="button">科研成果</a></p>
							</li>	
							<li class="grid_4 omega">
								<figure><img src="resources/images/service04.jpg" alt=""></figure>
								<p><a href="#" class="link">技术服务</a></p>
								本平台各组织成员在研究中发现的科研成果。
								<p><a href="#" class="button">科研成果</a></p>
							</li>							
						</ul>
