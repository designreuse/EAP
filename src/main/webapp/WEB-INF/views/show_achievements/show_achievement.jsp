...
<div class="wrapper">
  ...
  <!-- Main Sidebar -->
	<jsp:include page="../shell_frame/shell_frame_sidebar-1-3.jsp"/>
					...
					<div class="faceplate" >
						<div class="embed">										
	      					...
	      					<div class="callout callout-gray">
								<c:if test="${!empty achievement.team}">
									<strong>主要参与人员：</strong>${achievement.team}										
									<div class="dotted-line"></div>
								</c:if>												
								<c:if test="${!empty achievement.organization.name}">
									<strong>主要参与单位：</strong>${achievement.organization.name}						
									<div class="dotted-line"></div>
								</c:if>												
								<c:if test="${!empty achievement.experiment.title}">
									<strong>主要实验：</strong>${achievement.experiment.title}						
									<div class="dotted-line"></div>
								</c:if>
							</div>
	      					<div class="callout callout-gray">
								<div class="announcement_note">									
									<c:if test="${!empty achievement.note}">
      					...
      					<!-- ====================================================以上为第一层信息【基本信息】=============================================================== --> 
      							...
      							<div class="row col-md-12">
								<c:if test="${!empty achievement.time}">
									<p><div class="text-right" style=" text-align:right;">发布时间：${achievement.time}&nbsp;</div></p>
								</c:if>	
								</div>
					</div>
				</div>
