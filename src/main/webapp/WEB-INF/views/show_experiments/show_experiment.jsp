...
<div class="wrapper">
  ...
  <!-- Main Sidebar -->
	<jsp:include page="../shell_frame/shell_frame_sidebar-1-2.jsp"/>
	      ...
	      <div class="col-md-12">
	          <div class="box box-info frame-mini">
	            <div class="box-header with-border">
	              <h3 class="box-title">实验详情</h3>
	            </div>
	            <div class="box-body" >		            
	            <h3 class="text-center">${experiment.title}</h3>		
						...
						<div class="embed">										
	      					...
	      					<div class="callout callout-gray">
								<c:if test="${!empty experiment.team}">
									<strong>主要参与人员：</strong>${experiment.team}										
									<div class="dotted-line"></div>
								</c:if>												
								<c:if test="${!empty experiment.organization.name}">
									<strong>主要完成单位：</strong>${experiment.organization.name}						
									<div class="dotted-line"></div>
								</c:if>										
								<c:if test="${!empty experiment.equipment.name}">
									<strong>主要使用设备：</strong>${experiment.equipment.name}						
									<div class="dotted-line"></div>
								</c:if>	
							</div>
	      					<div class="callout callout-gray">
      					...
      					<!-- ====================================================以上为第一层信息【基本信息】=============================================================== --> 
								...
								<c:if test="${!empty experiment.time}">
									<p><div class="text-right" style=" text-align:right;">发布时间：${experiment.time}&nbsp;</div></p>
								</c:if>	
								</div>
					</div>
				</div>
