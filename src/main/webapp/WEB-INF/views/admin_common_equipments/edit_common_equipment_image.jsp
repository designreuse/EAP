...
<body>
    ...
    <div class="content">  
    	<c:url var="addAction" value="admin/updata/common_equipment" ></c:url>
		<form:form action="${addAction}" commandName="common_equipment">
			   		<%@ include file="common_equipment_form.jsp"%> 	  
