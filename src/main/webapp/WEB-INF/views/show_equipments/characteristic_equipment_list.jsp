				  ...
				  <div>
					<table  
				         ...
				         data-toolbar="#toolbar">
				      	...
				      	<tbody>
				      	<c:forEach items="${listCharacteristic_equipments}" var="equipment">									
							<tr>
								<td></td>
								<td>
						        <div class="herf_font_animal_name">
									<a href="show/characteristic_equipment/detail/${equipment.id}" target="_blank">												
										${equipment.name}											
									</a>
								</div>
								</td>		
