						...
						<div class="grid_animallist">
							<h2>实验动物列表</h2>
								<div class="testimonial-block-little">
									...
									<tr>
											<td style="text-align:right"><a class="button" href="super/species/create">添加新品系</a></td>
									<tr>
									<tr>
										...
										<c:if test="${!empty showSpeciess}">
											<c:forEach items="${showSpeciess}" var="species">									
												<tr>
													...
													<td style="text-align:center"><a class="button" href="<c:url value='/super/species/edit/${species.id}'/>" >编辑</a></td>
													<td style="text-align:right"><a class="button" href="<c:url value='/super/species/remove/${species.id}'/>" >删除</a></td>
												</tr>
							...
							<c:forEach var="i" begin="1" end="${numberSpeciess/15+0.934}">
									<% i=i+1; %>								
									<a href="super/species/${i}" class="button2">第${i}页</a>														
							</c:forEach>
