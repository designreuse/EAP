...
<div class="wrapper">
  ...
  <!-- Main Sidebar -->
	<jsp:include page="../shell_frame/shell_frame_sidebar-3-2.jsp"/>
				  ...
				  <div>
					<table  
				         ...
				         data-toolbar="#toolbar">
				      	...
				      	<tbody>
				      	<c:forEach items="${listTrainings}" var="announcement">									
							<tr>
								<td></td>
								<td>
						        <div class="herf_font_animal_name">
									<a href="show/training/detail/${announcement.id}" target="_blank">												
										${announcement.title}											
									</a>
								</div>
								</td>		
