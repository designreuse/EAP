      ...
      <body>  
		...
		<div class="container_12">	
      	<div class="picture-frame-gray">
						...
						<c:url var="addAction" value="/super/biochemical_data/update/${biochemical_data.id}" ></c:url>
      					...
      					<li class="line">
							...
							<form:input path="biochemical_classification" value="${biochemical_data.biochemical_classification}" readonly="true" type="hidden"/>
							<strong>
								测定组数据：
							</strong>
      						...
      						<!-- ====================================================以上为第二层信息【遗传数据】=============================================================== -->  
									...
									<c:if test="${!empty biochemical_data.time}">
											<p><div class="text-right" style=" text-align:right;">上次更新时间：${biochemical_data.time}</div></p>
									</c:if>
					</div>
					</form:form>
					</div>
