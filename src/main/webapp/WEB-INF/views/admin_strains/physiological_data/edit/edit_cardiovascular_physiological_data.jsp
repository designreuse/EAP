...
<body>
    <div class="content">  
    <h3 class="text-center">品系心血管生理数据信息</h3>
    	<c:url var="addAction" value="/admin/updata/physiological_data/${physiological_data.id}" ></c:url>
      	<form:form action="${addAction}" commandName="physiological_data" id="input-date">
			   		<%@ include file="../form/cardiovascular_physiological_data_form.jsp"%> 	  
