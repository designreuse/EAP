...
<script src="resources/js/ajax_db.js"></script>
	<p></p>
		<form:input id="physiological_classification" path="physiological_classification" readonly="true" type="hidden" value="temperature_physiological_data"/>
		...
		<strong>
			...
			<div class="second-embed">
				<label for="temperature">体温（<font class="second-embed-unit">℃</font>）：</label>
			    <form:input class="form-control" placeholder="请输入体温" path="temperature" />														    
			    <div class="dotted-line-nocolor"></div>
			</div>				
	<%
