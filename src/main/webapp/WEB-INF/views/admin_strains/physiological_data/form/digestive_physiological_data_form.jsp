...
<script src="resources/js/ajax_db.js"></script>
	<p></p>
		<form:input id="physiological_classification" path="physiological_classification" readonly="true" type="hidden" value="digestive_physiological_data"/>
		...
		<strong>
			...
			<div class="second-embed">				
				<label for="digestive_index">消化能力：</label>
			    <form:input class="form-control" placeholder="请输入消化能力" path="digestive_index" />	
			</div>				
	<%
