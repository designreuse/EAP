...
<body>
    ...
    <div class="content">  
    <h3 class="text-center">品系基本信息</h3>
    	<c:url var="addAction" value="admin/update/strain" ></c:url>
		<form:form action="${addAction}" commandName="strain">
			   		<%@ include file="strain_form.jsp"%> 	  
			    <div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<p></p>
						<input class="btn btn-success pull-right" type="submit" value="<spring:message text="更新基本信息,并进入详细数据编辑"/>" />
					</div>
				</div> 
