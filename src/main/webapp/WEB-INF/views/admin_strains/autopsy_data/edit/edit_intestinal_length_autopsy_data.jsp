...
<body>
    ...
    <div class="content">  
    <h3 class="text-center">品系肠道长度解剖数据信息</h3>
    	<c:url var="addAction" value="/admin/updata/autopsy_data/${autopsy_data.id}" ></c:url>
      	<form:form action="${addAction}" commandName="autopsy_data" id="input-date">
			   		<%@ include file="../form/intestinal_length_autopsy_data_form.jsp"%> 	  
