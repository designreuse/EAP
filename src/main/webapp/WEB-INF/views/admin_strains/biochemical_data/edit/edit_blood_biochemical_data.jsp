...
<body>
    ...
    <div class="content">  
    <h3 class="text-center">品系血液生化数据信息</h3>
    	<c:url var="addAction" value="/admin/updata/biochemical_data/${biochemical_data.id}" ></c:url>
      	<form:form action="${addAction}" commandName="biochemical_data" id="input-date">
			   		<%@ include file="../form/blood_biochemical_data_form.jsp"%> 	  
